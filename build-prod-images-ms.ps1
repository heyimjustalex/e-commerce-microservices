...
$pushCommand4 = "docker push heyimjustalex/authentication-db"
$pushCommand5 = "docker push heyimjustalex/orders-db"
$pushCommand6 = "docker push heyimjustalex/products-db"

$pushCommand7 = "docker push heyimjustalex/gateway-ms"
